				...
				<form id="registration" action="userOperations" method="post">
					...
					<div class="large-11 large-centered columns">
						<div class="row">
							...
							<div class="small-9 columns">
								<textarea id="right-label" name="_address" placeholder="Address"></textarea>
							</div>
						</div>
					</div>
					...
					<div class="large-11 large-centered columns">
						<div class="row">
							<div class="small-3 columns">
								<label for="right-label" class="right inline">Contact
									Number</label>
							</div>
							<div class="small-9 columns">
					...
					<div class="large-11 large-centered columns">
						<div class="row">
							<div class="small-3 columns">
								<label for="right-label" class="right inline">Permanent
									Number</label>
							</div>
							<div class="small-9 columns">
						...
						<div class="row">
							...
							<div class="small-9 columns">
								<input type="submit" class="medium button success round"
									id="right-label" name="_action" value="Register">
							</div>
						</div>
					</div>
